...
public class HighVisibilityWithCombiner {

  public static void main(String[] args) throws Exception {
    if (args.length != 2) {
      System.err.println("Usage: HighVisibilityWithCombiner <input path> " +
          "<output path>");
      System.exit(-1);
    }

    Job job = new Job();
    job.setJarByClass(HighVisibilityWithCombiner.class);
    ...
    /*[*/job.setCombinerClass(HighVisibilityReducer.class)/*]*/;
